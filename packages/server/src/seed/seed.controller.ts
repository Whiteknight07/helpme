...
import { EmbeddableGradingProfileModel } from '../lti/embeddable/question/grading-profile.entity';
...
export class SeedController {
  ...
  async deleteAll(): Promise<string> {
    ...
    await this.seedService.deleteAll(EmbeddableGradingProfileModel);
  ...
  async fillAnytimeQuestions(): Promise<string> {
    ...
    // createList is faster than looping 100 times (thanks bridgette)
    // need to pass course and creator so it doesn't generate 100 dummy users and courses (thanks adam)
    await this.factoryService.AsyncQuestionFactory.createList(100, {
      course: course,
      creator: creator,
      questionAbstract: `Test Anytime Question`,
      questionText: `This is a test question generated by the "Generate 100 Anytime Questions" button.`,
      aiAnswerText: `This is a test AI answer generated for pagination testing.`,
    });
